...
public class CapstoneDsuFall2017RoseRobInventoryProjectApplication {
	...
	public CommandLineRunner initializeDb(ItemRepo itemRepo, RoomRepo roomRepo, AddressRepo addressRepo, BuildingRepo buildingRepo, StudentRepo studentRepo, OrganizationRepo organizationRepo, ItemImageRepo imageRepo, SettingsRepo settingsRepo) {
		return (args) -> {
			...
			uriComponents = UriComponentsBuilder.newInstance().path("/items/"+item3.getId()).build();
			...
			item4.setColor("blue");
			uriComponents = UriComponentsBuilder.newInstance().path("/items/"+item4.getId()).build();
			...
			uriComponents = UriComponentsBuilder.newInstance().path("/items/"+item5.getId()).build();
			...
			uriComponents = UriComponentsBuilder.newInstance().path("/items/"+item6.getId()).build();
